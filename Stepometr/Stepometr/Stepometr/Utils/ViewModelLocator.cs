...
namespace Stepometer.Utils
{
    public class ViewModelLocator
    {
        ...
        public static StepometerViewModel StepometerViewModel { get; set; } = new StepometerViewModel(DependencyResolver.Get<IStepometerService>(), DependencyResolver.Get<IDBService>());
